...
export default function GuidancePage() {
  ...
  return (
    <div className="min-h-screen bg-purple-900 p-0 sm:p-0 md:p-0 lg:p-0">
      ...
      <div className="bg-white px-1 py-4 sm:px-2 lg:px-3 mb-6">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
          ...
          >
            <div className="flex flex-col items-center space-y-2">
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-violet-600 font-medium">Évaluation</div>
              </div>
            </div>
          </button>
          ...
          <button 
            ...
            aria-label="Consulter les recommandations"
          >
            <div className="flex flex-col items-center space-y-2">
          ...
          <button 
            ...
            aria-label="Consulter le plan d'action"
          >
            <div className="flex flex-col items-center space-y-2">
      ...
      {/* Menu d'actions rapides - Bouton flottant droit */}
      <div className="floating-menu-container fixed bottom-6 right-6 z-40">
        {/* Menu contextuel */}
        {isFloatingMenuOpen && (
