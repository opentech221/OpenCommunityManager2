...
interface AddMemberModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAdd: (member: Omit<MemberType, 'id' | 'joinDate'>) => void;
}
...
const AddMemberModal: React.FC<AddMemberModalProps> = ({ isOpen, onClose, onAdd }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onAdd({
      ...
      associationId: '1' // À adapter selon votre logique d'association
    });
              ...
              <div className="flex">
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    <strong>Note :</strong> Le nouveau membre recevra un email de bienvenue avec ses informations de connexion.
                  </p>
                </div>
              </div>
            </div>
