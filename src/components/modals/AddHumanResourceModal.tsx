...
interface AddHumanResourceModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (resource: Omit<HumanResourceType, 'id'>) => void;
}

const AddHumanResourceModal: React.FC<AddHumanResourceModalProps> = ({ isOpen, onClose, onSave }) => {
  const [formData, setFormData] = useState({
    ...
    position: '',
    experience: '',
    availability: 'DISPONIBLE' as 'DISPONIBLE' | 'OCCUPÉ' | 'INDISPONIBLE',
    skills: [''],
    notes: ''
  });
...
export default AddHumanResourceModal;
